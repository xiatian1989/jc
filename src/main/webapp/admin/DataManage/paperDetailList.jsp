...
<script type="text/javascript">
	...
	$(function() {
		var paperId = GetQueryString("value");
		$('#dg').datagrid({
			nowrap : false,
			idField : 'id',
			striped : true,
...
<table id="dg" title="题目列表">
	...
	<div id="toolbar">
		<a href="${pageContext.request.contextPath}/admin/DataManage/papertList.jsp" class="easyui-linkbutton" iconCls="icon-back" plain="true">返回</a>
	...
	<div id="dlgForUpload" class="easyui-dialog"
		...
		<form method="post" enctype="multipart/form-data" id="uploadExcel" style="margin-top:20px">
			 导入数据之前，请先<a href="${pageContext.request.contextPath}/templet/paperDetail.xls">下载模板</a>
			  <p>
			  <p>
